...
rrd_html_summary_df = function(cmd_df, issue_df = NULL, parcels = list(), opts = rrd_opts()) {
  ...
  if (is.null(cmd_df) || NROW(cmd_df) == 0) {
    return(data.frame(
      item = c(
        ...
        "Regression commands",
        "Correct regressions",
        "Regressions with issues",
        "Commands with errors",
        "Missing data sets"
      ),
      value = c(0L, 0L, 0L, 0L, 0L, 0L),
      stringsAsFactors = FALSE
    ))
  }
  ...
  reg_has_issue = is_reg & (has_error | has_problem_reg)
  missing_data_df = rrd_html_missing_dataset_df(cmd_df, parcels = parcels, opts = opts)
  ...
  data.frame(
    item = c(
      ...
      "Correct regressions",
      "Regressions with issues",
      "Regression commands with regcheck issues",
      "Regression commands with Stata errors",
      "Commands with errors",
      "Non-regression commands with errors",
